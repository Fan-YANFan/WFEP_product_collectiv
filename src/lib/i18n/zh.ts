...
export const zh: Translations = {
  ...
  home: {
    ...
    cta: "立即預約首次回收",
    feature1Title: "搜尋全港回收點",
    feature1Desc: "按地區、廢物種類或附近地點篩選，涵蓋日常回收點及政府與社區回收計劃。",
    feature2Title: "短期活動集中一覽",
    feature2Desc: "政府及社區的短期回收計劃，清楚顯示時間、規則，已結束活動亦保留供參考。",
    feature3Title: "收藏、提醒或預約上門",
    feature3Desc: "收藏常用地點、在帳戶接收活動到期提醒，需要時亦可預約上門回收。",
  ...
  explorer: {
    ...
    foodWasteCampaignTitle: "環保署廚餘回收流動點",
    foodWasteCampaignDesc:
      "全港105個晚間定時定點街站及流動車回收點，為附近居民及小型商戶提供廚餘回收服務，廚餘會送往政府處理設施。",
    foodWasteRule1: "只限廚餘，請勿混入膠袋、餐具或包裝物。",
    foodWasteRule2: "各點只於指定晚間時段運作，前往前請查看營業時間。",
    foodWasteRule3: "標示 # 的地點由夜間廚餘回收車提供服務。",
    foodWasteCampaignLink: "計劃概覽 →",
    foodWasteSpotsPdfLink: "官方流動點列表（PDF）→",
